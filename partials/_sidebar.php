        ...
        <ul class="nav">
          ...
          <li class="nav-item" <?php //echo $_SESSION['md_fornecedor'];?>>
            <a class="nav-link" data-toggle="collapse" href="#cliente_comercial" aria-expanded="false" aria-controls="cliente_comercial">
              ...
              <span class="menu-title">Cliente Comercial</span>
...
<!--navbar navbar-expand-lg navbar-light bg-light-->
      <nav class="navbar fixed-bottom navbar-expand-lg navbar-light bg-light">
        ...
        <div class="btn-group btn-group-lg" role="group" aria-label="...">
          ...
          <button class="rounded-circle btn btn-lg btn-outline-success" type="button" style="margin:10px; padding: 10px;">Início</button>
          <button class="rounded-circle btn btn-lg btn-outline-info" type="button" style="margin:10px; padding: 10px;">Perfil</button>
          <button class="rounded-circle btn btn-lg btn-outline-info" type="button" style="margin:10px; padding: 20px;">Mais Ações</button>
